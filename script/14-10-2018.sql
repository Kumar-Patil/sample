...
--
-- Dumping data for table `boosting_fare`
--

LOCK TABLES `boosting_fare` WRITE;
/*!40000 ALTER TABLE `boosting_fare` DISABLE KEYS */;
INSERT INTO `boosting_fare` VALUES (1,1,1);
/*!40000 ALTER TABLE `boosting_fare` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `cabs_online`
--

DROP TABLE IF EXISTS `cabs_online`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `cabs_online` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
  `source` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `destination` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_online` tinyint(4) NOT NULL DEFAULT '0',
  `source_lat` decimal(15,8) DEFAULT NULL,
  `source_lng` decimal(15,8) DEFAULT NULL,
  `destination_lat` decimal(15,8) DEFAULT NULL,
  `destination_lng` decimal(15,8) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `last_updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cabs_online_user_id_foreign` (`user_id`),
  CONSTRAINT `cabs_online_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=270 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cabs_online`
--

LOCK TABLES `cabs_online` WRITE;
/*!40000 ALTER TABLE `cabs_online` DISABLE KEYS */;
INSERT INTO `cabs_online` VALUES (1,88,'blr','blr',1,23.00000000,345.00000000,55.00000000,55.00000000,NULL,NULL,NULL),(2,88,'blr','blr',1,45.00000000,54.00000000,4554.00000000,456.00000000,NULL,NULL,NULL),(269,88,'sex','sss',1,4.00000000,6.00000000,4.00000000,4.00000000,'2018-10-14 11:49:31','2018-10-14 11:49:31',NULL);
/*!40000 ALTER TABLE `cabs_online` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `delivery_progress` (
  ...
  `source` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `destination` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_progress` tinyint(4) NOT NULL DEFAULT '0',
  `source_lat` decimal(15,8) DEFAULT NULL,
  `source_lng` decimal(15,8) DEFAULT NULL,
  `destination_lat` decimal(15,8) DEFAULT NULL,
  `destination_lng` decimal(15,8) DEFAULT NULL,
  ...
  `last_updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `delivery_progress_user_id_foreign` (`user_id`),
  CONSTRAINT `delivery_progress_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=269 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `delivery_progress`
--

LOCK TABLES `delivery_progress` WRITE;
/*!40000 ALTER TABLE `delivery_progress` DISABLE KEYS */;
INSERT INTO `delivery_progress` VALUES (1,88,1,'asdsa','asdas',1,56.00000000,66.00000000,66.00000000,6.00000000,NULL,NULL,NULL);
/*!40000 ALTER TABLE `delivery_progress` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `delivery_system` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `delevery_completed_at` timestamp NULL DEFAULT NULL,
  `last_updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `delivery_system` VALUES (17,88,1,'string','completed','string','string',3,40,'1970-01-18 17:20:39','1970-01-18 17:20:39','1970-01-18 17:20:39','string','patil','patil','string','string','string','string','string','string','string','2018-07-10 17:52:59','2018-07-10 18:11:54','2018-07-13 12:58:26','2018-08-27 07:29:10','2018-08-27 07:29:10'),(18,88,1,'sdfsdf','completed','sdfsd','sdfsdf',5,5,'1970-01-18 17:20:39','1970-01-18 17:20:39','1970-01-18 17:20:39','sdfsdf','sdfsdf','sdfsdf','sdfs',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2018-07-13 13:00:06','2018-08-27 07:29:10','2018-08-27 07:29:10');
...
INSERT INTO `driver_cab_online` VALUES (1,88,'blr','blr btm',1,0,33.00000000,33.00000000,NULL,NULL,NULL),(2,88,'blr','blr',1,1,22.00000000,22.00000000,NULL,NULL,NULL),(3,88,'blr','blr housa',1,0,3.00000000,3.00000000,NULL,NULL,NULL),(4,88,'blr','blr',1,1,2.00000000,2.00000000,NULL,NULL,NULL),(5,88,'blr','blr',1,1,22.00000000,22.00000000,NULL,NULL,NULL),(6,114,'blr','blr',1,0,33.00000000,33.00000000,NULL,NULL,NULL);
...
CREATE TABLE `trips` (
  ...
  `destincation_lat` decimal(15,8) DEFAULT NULL,
  `destination_lng` decimal(15,8) DEFAULT NULL,
  `source_lat` decimal(15,8) DEFAULT NULL,
  `source_lng` decimal(15,8) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `trips` VALUES (102,88,88,88,1,'Basapura Village Road, Vittasandra, Bengaluru, Karnataka 560100, India','Shivajinagar Bus Stand Rd, Narveer Tanaji Wadi, Shivajinagar, Pune, Maharashtra 411005, India','in progress','2018-09-30 16:24:23','2018-09-30 16:24:23','2018-09-30 16:24:23','2018-09-30 16:24:23',0.00,0.00,0.00,0.00,'2018-09-30 16:24:23','2018-09-30 16:24:23','2018-09-30 16:24:23','Bookking',18.53358700,73.84903000,12.85966400,77.64696500),(103,88,88,88,1,'Gulbarga Fort, Halbarga, Brhampur, Kalaburagi, Karnataka 585101, India','Hyderabad - Warangal Hwy, Raipura, Hanamkonda, Telangana, India','in progress','2018-09-30 16:24:50','2018-09-30 16:24:50','2018-09-30 16:24:50','2018-09-30 16:24:50',0.00,0.00,0.00,0.00,'2018-09-30 16:24:50','2018-09-30 16:24:50','2018-09-30 16:24:50','Bookking',18.00476800,79.57502000,17.34048800,76.82961000);
...
INSERT INTO `user_mapping` VALUES (88,110),(88,112),(88,113),(88,114),(88,115),(88,116),(88,117),(88,118),(88,121),(88,122),(88,125),(88,130),(88,131),(88,132),(88,133),(131,134);
...
INSERT INTO `user_online` VALUES (1,88,'sex','sss',1,'2018-10-14 11:35:24','2018-10-14 11:35:24',NULL,4.00000000,6.00000000,4.00000000,4.00000000),(2,1,'vb','vb',1,'2018-08-25 14:15:27','2018-08-25 14:15:27','2018-08-25 14:15:27',5.00000000,5.00000000,4.00000000,4.00000000),(268,1,'fg','vb',1,'2018-08-26 14:15:27','2018-08-26 14:15:27','2018-08-25 14:15:27',4.00000000,4.00000000,4.00000000,4.00000000),(269,88,'sex','sss',1,'2018-10-14 11:41:25','2018-10-14 11:41:25',NULL,4.00000000,6.00000000,4.00000000,4.00000000);
...
CREATE TABLE `users` (
  ...
  `vendor_registration_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'Supreme User','sadsada',1,1,NULL,'Santosh','patil','santhu.gouda@gmail.com1','san',0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(83,'Supreme User','345345',NULL,NULL,NULL,'Kumar','Patil','info.patil87@gmail.com','san',0,0,0,NULL,'2018-06-25 11:55:04','2018-06-25 11:55:04','2018-07-13 17:01:34',NULL,'2018-06-25 11:55:04','2018-06-25 11:55:04','male','900909',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(88,'Supreme User','34532249015',241,246,237,'Kumar','Patil','santhu.gouda@gmail.com','san',1,0,0,NULL,'2018-06-25 12:16:01','2018-06-25 12:37:26','2018-06-25 12:39:14',NULL,'2018-06-25 12:37:26','2018-06-25 12:37:26','male','900909',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(90,'Vendor','544445',242,247,260,'vendor','asd','santhu.gouda@gmail.com12','asdasd',0,0,0,NULL,'2018-07-13 17:48:31','2018-07-13 17:52:51','2018-08-25 20:55:35',NULL,'2018-07-13 17:52:51','2018-07-13 17:52:51','male','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(91,'Vendor','45546456',243,248,261,'vendor','asd','kumar@gmail','asdasd',0,0,0,NULL,'2018-07-13 17:55:17','2018-07-13 17:55:37','2018-07-13 17:55:42',NULL,'2018-07-13 17:55:37','2018-07-13 17:55:37','other','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(94,'rider','78776878',247,252,270,'asd','asd','santhu.gouda@gmail.com23','d',0,0,0,NULL,'2018-08-26 11:23:33','2018-08-26 11:23:33','2018-08-26 11:34:57',NULL,'2018-08-26 11:23:33','2018-08-26 11:23:33','male','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(97,'rider','878888444',250,255,273,'Kumar','Patil','info.gouda@gmail.com','san',0,0,0,NULL,'2018-08-26 11:44:00','2018-08-26 11:44:00','2018-08-26 12:03:21',NULL,'2018-08-26 11:44:00','2018-08-26 11:44:00','male','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(101,'rider','9000854688',254,259,277,'rr','rr','santhu.gouda13@gmail.com7','san',0,0,0,NULL,'2018-08-26 12:07:21','2018-08-26 12:07:21',NULL,NULL,'2018-08-26 12:07:21','2018-08-26 12:07:21','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(109,'rider','asdad',262,267,286,'rrr','rr','asdasd','asdas',0,0,0,NULL,'2018-08-26 12:21:38','2018-08-26 12:21:38',NULL,NULL,'2018-08-26 12:21:38','2018-08-26 12:21:38','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(110,'rider','sdsf',263,268,287,'rr','rr','santhu.gouda@34gmail.com','san',0,0,0,NULL,'2018-08-26 12:28:02','2018-08-26 12:28:02',NULL,NULL,'2018-08-26 12:28:02','2018-08-26 12:28:02','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(112,'rider','9967854688',265,270,289,'rr','rr','santhu.gouda@4566gmail.com','san',0,0,0,NULL,'2018-08-26 12:33:02','2018-08-26 12:33:02',NULL,NULL,'2018-08-26 12:33:02','2018-08-26 12:33:02','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(113,'Supreme User','2249015',266,271,290,'rr','r','santhu.gouda@ddgmail.com','d',0,0,0,NULL,'2018-08-26 12:39:41','2018-08-26 12:39:41','2018-08-26 12:41:50',NULL,'2018-08-26 12:39:41','2018-08-26 12:39:41','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(114,'Supreme User','san',267,272,291,'Santosh Patil','asdasd','santhu.gouda@11gmail.com','san',0,0,0,NULL,'2018-08-26 12:46:22','2018-08-26 15:49:49',NULL,NULL,'2018-08-26 15:49:49','2018-08-26 15:49:49','male','','','',NULL,'',NULL,NULL,NULL,NULL),(115,'Super User','sss',268,273,292,'Santosh kumar','Santosh kumar','santhu.gouda@gmsail.coms','ss',0,0,0,NULL,'2018-08-26 12:49:06','2018-08-26 15:50:08',NULL,NULL,'2018-08-26 15:50:08','2018-08-26 15:50:08','','','','','2018-08-07 18:30:00','',NULL,NULL,NULL,NULL),(116,'Supreme User','99800000',269,274,293,'','','asdasd@fggg.com','ddd',0,0,0,NULL,'2018-08-26 13:11:43','2018-08-26 15:47:18','2018-08-26 15:50:49',NULL,'2018-08-10 18:30:00','2018-08-09 18:30:00','','','','Software develper',NULL,'','2018-08-18 18:30:00','2018-08-11 18:30:00',NULL,NULL),(117,'driver','6766666',270,275,294,'fucnking','','santos@gmail.com','dadd',0,0,0,NULL,'2018-08-26 13:14:09','2018-08-26 13:14:09','2018-08-26 13:14:25',NULL,'2018-08-26 13:14:09','2018-08-26 13:14:09','','','','fucnking',NULL,'fucnking',NULL,NULL,NULL,NULL),(118,'driver','67777',279,284,303,'asdad','asd','info.patil900@gmail.com','san',0,0,0,NULL,'2018-08-26 13:49:39','2018-08-26 13:49:39',NULL,NULL,'2018-08-03 18:30:00','2018-08-09 18:30:00','male','','','','2018-08-08 18:30:00','asdasd','2018-08-11 18:30:00','2018-08-11 18:30:00',NULL,NULL),(121,'Super User','0000000',287,292,311,'patil','Patil','santhu.gouda@ghhhhgmail.com','san',0,0,0,NULL,'2018-08-26 15:18:02','2018-08-26 15:52:03',NULL,NULL,'2018-08-26 15:52:03','2018-08-26 15:52:03','','','','',NULL,'',NULL,NULL,NULL,NULL),(122,'Supreme User','988887888',288,293,312,'','','kori@gmail.com','san',0,0,0,NULL,'2018-08-26 15:53:18','2018-08-26 15:53:18',NULL,NULL,NULL,NULL,'','','','',NULL,'',NULL,NULL,NULL,NULL),(125,'Supreme User','656666',291,296,315,'ffffffffff','dddddddddddd','hh@gmail.com','san',0,0,0,NULL,'2018-08-26 15:55:56','2018-08-26 16:18:23',NULL,NULL,'2018-08-26 16:18:23','2018-08-26 16:18:23','male','6778888','dfsdfsfdd','Software develper',NULL,'Vishwanath Reddy',NULL,NULL,'ggggggg','sadasdas'),(130,'Supreme User','56789777',297,303,322,'','','santhu.gouda@123456gmail.com','san',0,0,0,NULL,'2018-08-30 16:25:49','2018-08-30 16:25:49',NULL,NULL,NULL,NULL,'','','','',NULL,'',NULL,NULL,NULL,NULL),(131,'Super User','457757867',298,304,323,'Super User','Super User','superuser@yahoo.com','san',1,0,0,NULL,'2018-08-30 17:01:09','2018-08-30 17:01:36',NULL,NULL,'2018-08-30 17:01:36','2018-08-30 17:01:36','male','','','',NULL,'',NULL,NULL,NULL,NULL),(132,'Vendor','6577667766',299,305,324,'Vendor Name','Vendor Name','vendor@yahoo.com','san',1,0,0,NULL,'2018-08-30 17:02:50','2018-08-30 17:02:50',NULL,NULL,NULL,NULL,'female','','vendor@yahoo.com','',NULL,'',NULL,NULL,NULL,NULL),(133,'View User','768886',300,306,325,'viewuser','view','viewuser@yahoo.com','san',1,0,0,NULL,'2018-08-30 17:04:05','2018-08-30 17:04:20',NULL,NULL,'2018-08-30 17:04:20','2018-08-30 17:04:20','male','','','',NULL,'',NULL,NULL,NULL,NULL),(134,'Vendor','3456444',301,307,326,'','','superuserv@yahoo.com','san',1,0,0,NULL,'2018-08-30 17:06:38','2018-08-30 17:06:38',NULL,NULL,NULL,NULL,'','','456789','',NULL,'',NULL,NULL,NULL,NULL);
...
-- Dump completed on 2018-10-14 17:24:19
