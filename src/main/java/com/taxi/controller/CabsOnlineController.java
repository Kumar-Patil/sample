 ...
 */
@Controller
@RequestMapping("/cabsOnline")
@Api(value = "cabsOnline")
@Consumes(javax.ws.rs.core.MediaType.APPLICATION_JSON)
@Produces(javax.ws.rs.core.MediaType.APPLICATION_JSON)
public class CabsOnlineController {
    ...
    public ResponseEntity<?> add(@RequestParam("userId") long userId, @RequestBody OnlineUserPushData onlineUserPushData) {
        ...
        try {
            CabsOnline online = new CabsOnline();
            ...
            boolean isAdded = cabsOnlineService.update(online);
            if (isAdded) {
